...
* [SunSpider](https://www.webkit.org/perf/sunspider/sunspider.html) - :warning: no longer maintained. A JavaScript benchmark. This benchmark tests the core JavaScript language only, not the DOM or other browser APIs. It is designed to compare different versions of the same browser, and different browsers to each other. :ru: бенчмарк основных компонентов JavaScript, но не элементов DOM или других API браузеров. Его целью является выяснение работоспособности браузера в задачах, существующих в реальном мире, а также возможных в ближайшем будущем. Разработан командой WebKit.
* [Octane](https://chromium.github.io/octane/) - the Javascript benchmark for the modern web. [![GitHub stars](https://img.shields.io/github/stars/chromium/octane.svg?style=social)](https://github.com/chromium/octane)
* [Kraken](http://krakenbenchmark.mozilla.org) :ru: Бенчмарк скорости движка JavaScript Kraken разрабатывался создателем Firefox, компанией Mozilla.
* [JetStream](http://browserbench.org/JetStream/) - a JavaScript benchmark suite focused on the most advanced web applications. :ru: писался компанией Apple. Бенчмарк проводит несколько тестов JavaScript, а затем считает геометрическое среднее их результатов.
* [OortOnline.gl](http://oortonline.gl) - an online benchmark application that measures the performance of your WebGL compatible device, powered by Oort Online. :ru: Онлайн-приложение OortOnline.gl меряет производительность WebGL, компонента JavaScript для рендеринга 2D- и 3D-графики.
...
|Preview|Source|
|------------ | -------------|
|[![What is reCAPTCHA?](http://habrastorage.org/files/b16/811/fc5/b16811fc59034eb8ae3b7ff0639ea229.png)](https://developers.google.com/recaptcha/)<br>[![При успешном разгадывании изображения капча примет следующий вид](http://habrastorage.org/files/5bf/e1a/0df/5bfe1a0dff3640d09685f9d1763de6d6.png)](https://developers.google.com/recaptcha/)|[Demo](https://www.google.com/recaptcha/api2/demo) [![reCAPTCHA PHP client library on GitHub](https://img.shields.io/github/stars/google/ReCAPTCHA.svg?label=PHP+library&style=social)](https://github.com/google/ReCAPTCHA)<br>:ru: ![Хабрахабр][Habr Icon] [Вышла новая версия reCaptcha API 2.0](http://habr.ru/p/244779) - Хабрахабр.|
|[![Mollom CAPTCHA](https://breezewebsitebuilder.com/docs/cms/images/mollom_captcha.jpg)](https://mollom.com)|[Mollom: Content monitoring](https://mollom.com) - Mollom is a free web service to get rid of spam, unwanted content and fake users on your Drupal, Wordpress and Joomla site or blog.<br>[![Mollom PHP client library on GitHub](https://img.shields.io/github/stars/Mollom/MollomPHP.svg?label=PHP+library&style=social)](https://github.com/Mollom/MollomPHP)|
|[![std (цифры, русскоязычный логотип)](https://yastatic.net/doccenter/images/tech-ru/cleanweb/freeze/Bw0CdqiK66OFlfkybE3fWveSya8.gif)](https://tech.yandex.ru/cleanweb/doc/dg/concepts/get-captcha-docpage/)<br>[![lite (простые для чтения цифры, русскоязычный логотип)](https://yastatic.net/doccenter/images/tech-ru/cleanweb/freeze/0WLRscWa-KXnsJM3K9jyjORMUEc.gif)](https://tech.yandex.ru/cleanweb/doc/dg/concepts/get-captcha-docpage/)<br>[![elatm (латинские буквы смешанного регистра, англоязычный логотип)](https://yastatic.net/doccenter/images/tech-ru/cleanweb/freeze/EXn6jNYFPPiYDb5UhCZoo4c39nE.gif)](https://tech.yandex.ru/cleanweb/doc/dg/concepts/get-captcha-docpage/)<br>[![rus (русские буквы, русскоязычный логотип)](https://yastatic.net/doccenter/images/tech-ru/cleanweb/freeze/DX8nVRBWxTKXpjLtmblZpWk5bcw.gif)](https://tech.yandex.ru/cleanweb/doc/dg/concepts/get-captcha-docpage/)|:warning: *Внимание! К сожалению, данный API более не поддерживается. Новые ключи не выдаются, а 1 октября 2015 года API будет выключен полностью.*<br>:ru: [API Чистого веба — Общие сведения — Технологии Яндекса](https://tech.yandex.ru/cleanweb/) - Сервис  Яндекс.Чистый веб предназначен для борьбы со спамом в текстовых сообщениях, размещаемых пользователями и автоматическими роботами на страницах сайтов, форумов  и пр. [Распознавание кириллической Яндекс капчи / Хабрахабр](http://habr.ru/p/264489)|
|[![KeyCAPTCHA Preview](https://www.keycaptcha.com/media/images/magnetic-en.png)](https://keycaptcha.com)|[KeyCAPTCHA - Innovative Anti-Spam Solution](https://keycaptcha.com) - Powerful anti-spam website protection.|
|[![KCAPTCHA Preview](http://captcha.ru/captcha2/)](http://captcha.ru/en/kcaptcha/)<hr>[![KCAPTCHA Old Preview](http://captcha.ru/captcha/)](http://captcha.ru/en/kcaptcha1/)|[KCAPTCHA project](http://captcha.ru/en/kcaptcha/) - KCAPTCHA is a free and open source PHP solution to generate human validation images (CAPTCHA). KCAPTCHA is meant to be a very strong protected one but requires no special hosting features, only PHP with GD library. :ru: [Проект KCAPTCHA - CAPTCHA.ru](http://captcha.ru/kcaptcha) — это готовое решение, написанное на языке PHP, которое вы можете бесплатно скачать и установить на свой сайт для защиты от спама и флуда. Проект KCAPTCHA ставит перед собой цель предложить программисту решение с одной стороны весьма защищенное, с другой — максимально малотребовательное к ресурсам и конфигурации хостинга. ![Хабрахабр][Habr Icon] [Распознавание KCAPTCHA / Хабрахабр](http://habr.ru/p/263127)|
...
* [Browser Specific Hacks | CSS-Tricks](https://css-tricks.com/snippets/css/browser-specific-hacks/)
...
> *__Crowdfunding__ is the practice of funding a project or venture by raising monetary contributions from a large number of people, typically via the internet.<br>- ["Crowdfunding"](https://en.wikipedia.org/wiki/Crowdfunding) @ Wikipedia*

* ["Comparison of crowdfunding services"](https://en.wikipedia.org/wiki/Comparison_of_crowdfunding_services) @ Wikipedia.
...
* [Crowdcube](https://crowdcube.com) - the world's first equity crowdfunding platform, online investing just got easier. [![Follow @Crowdcube](https://img.shields.io/twitter/url/https/www.crowdcube.com.svg?label=@Crowdcube&style=social)](https://twitter.com/crowdcube)
...
* ["Plus addressing"](https://en.wikipedia.org/wiki/Email_address#Sub-addressing) @ Wikipedia. :ru: [Почтовые синонимы в Gmail](http://demin.ws/blog/russian/2012/09/06/gmail-aliases/) - Александр Дëмин.
...
* [ProtonMail](https://protonmail.ch) - Secure email based in Switzerland with absolutely no compromises. Get your free encrypted email account today. :ru: [ProtonMail](http://geektimes.ru/p/265370) — это почтовый сервис, созданный специалистами по сетевой безопасности и CERN. Цель — запуск в роботу почтовика, который был бы полностью защищен от влияния разведслужб любой страны. Этот почтовый сервис — один из наиболее защищенных в мире. К примеру, вся информация шифруется еще на стороне клиента, а все серверы сервиса располагаются на территории Швейцарии. В этой стране очень сложно, если вообще возможно, получить доступ к чьей-либо частной информации. Для авторизации пользователя используется двухфакторная аутентификация, с двумя паролями.
...
* [Google Noto Fonts](https://www.google.com/get/noto/) - Noto's goal is to provide a beautiful reading experience for everyone and for all languages. With visual harmony when multiple languages share a page. With multiple styles and weights. And Freely available to all. [![GitHub stars](https://img.shields.io/github/stars/googlei18n/noto-fonts.svg?style=social)](https://github.com/googlei18n/noto-fonts)
...
* :octocat: [Iosevka](https://be5invis.github.io/Iosevka/) - Spatial efficient monospace font family for programming. Built from code. [![Хабрахабр][Habr Icon] Iosevka — ещё один шрифт для кодинга](http://habr.ru/p/275045) [![GitHub stars](https://img.shields.io/github/stars/be5invis/Iosevka.svg?style=social)](https://github.com/be5invis/Iosevka)
...
* :ru: ![VKontakte][VK Icon] [Библиотека программиста - Подборка материалов по Git и Github](https://vk.com/wall-54530371_34613)
...
* [GitHub Awards : Discover your ranking on GitHub](http://github-awards.com) - Find out what is your rank by language, in your city and in your country. [![GitHub stars](https://img.shields.io/github/stars/vdaubry/github-awards.svg?style=social)](https://github.com/vdaubry/github-awards) ![license](https://img.shields.io/github/license/vdaubry/github-awards.svg?style=social)
* :octocat: [GitHub Cheat Sheet](https://git.io/sheet) - A collection of cool hidden and not so hidden features of Git and GitHub. [![GitHub stars](https://img.shields.io/github/stars/tiimgreen/github-cheat-sheet.svg?style=social)](https://github.com/tiimgreen/github-cheat-sheet)
...
* [We Love Icon Fonts](http://weloveiconfonts.com) - A free & open source icon fonts hosting service for testing purposes. [![Follow @WeLoveIconFonts](https://img.shields.io/twitter/url/http/weloveiconfonts.com.svg?label=@WeLoveIconFonts&style=social)](https://twitter.com/weloveiconfonts) [GitHub](https://github.com/TimPietrusky/weloveiconfonts)
...
* [Pootle](http://pootle.translatehouse.org) - Online translation platform. Pootle allows your professional or community translators to easily complete localization tasks. For you it becomes easier to manage and monitor the distributed work. Pootle is written in Python using the Django framework. [![GitHub stars](https://img.shields.io/github/stars/translate/pootle.svg?style=social)](https://github.com/translate/pootle)
...
* :ru: [![Хабрахабр][Habr Icon] Обзор 7 онлайн-сервисов для локализации ПО](https://habr.ru/p/229031)
...
* [REST API Tutorial](http://www.restapitutorial.com) - Learn REST API best practices. :ru: Russian translation: [Изучаем REST: Руководство по созданию RESTful сервиса](http://www.restapitutorial.ru) [![GitHub stars](https://img.shields.io/github/stars/tfredrich/RestApiTutorial.com.svg?style=social)](https://github.com/tfredrich/RestApiTutorial.com)
...
* :ru: [Text.ru](http://text.ru) - Проверка текста на уникальность онлайн, точная и быстрая проверка покажет процент уникальности статьи. [![API Reference][API Icon]](http://text.ru/api-check)
...
* :ru: [Яндекс.Спеллер](https://tech.yandex.ru/speller/) - помогает находить и исправлять орфографические ошибки в русском, украинском или английском тексте. Для этого используется орфографический словарь. Спеллер подключается к любой HTML-форме на сайте с помощью веб-приложения. А благодаря API Яндекс.Спеллера (JavaScript или HTTP) разработчики могут реализовать проверку правописания в своих приложениях.

## Typographs
> *__Типограф__ — это удобное средство онлайн подготовки текста к веб-изданию. Он помогает избежать монотонной корректировки, расстановки кавычек, неразрывных пробелов, специальных символов, исправляет некоторые ошибки ввода (опечатки) и так далее.<br>- [typograf.ru](http://typograf.ru/about/)*
...
* :ru: [Публичная порка он-лайн типографов](http://typograf.ru/flog/)
* :ru: [Типограф](http://www.artlebedev.ru/tools/typograf/) - Студия Артемия Лебедева.
* :ru: [Типограф](http://typograf.ru) - Eugene Spearance.
...
|Preview|Source|
|------------ | -------------|
|[![Preview](http://research.swtch.com/qart2.png)](http://research.swtch.com/qr/draw)|[QArt Coder](http://research.swtch.com/qr/draw) - you give it a URL and a high-contrast photo, and it adds a carefully chosen set of digits to the end of the URL where the digits chosen end up representing the photo.|
|[![Preview](http://vanity-qrcode.com/assets/placeholder.png)](http://vanity-qrcode.com)|[Vanity QR Code Generator](http://vanity-qrcode.com) - allows people to create QR codes with text overlaid on them. [Blog post](http://aaron.pk/a4dZ1)|
...
* [HPKP online tools by Scott Helme](https://report-uri.io/home/tools) - Analyse the PKP of your site or any other site. Generate a Public Key Pin for a site by providing the URL, your PEM encoded Certificate, Public Key or Certificate Signing Request.
...
* [Whoer.net](https://whoer.net) - a service aimed at verifying the information your computer sends to the web. :ru: [Whoer.net](https://whoer.net/ru) - сервис проверки передаваемой вашим компьютером информации в сеть Интернет.
* [Panopticlick](https://panopticlick.eff.org) - Is your browser safe against tracking? Panopticlick will analyze how well your browser and add-ons protect you against online tracking techniques. We’ll also see if your system is uniquely configured—and thus identifiable—even if you are using privacy-protective software. :ru: [![Хабрахабр][Habr Icon] EFF выпустил Panopticlick 2.0 для фингерпринтинга браузера](http://geektimes.ru/p/267958) [![GitHub stars](https://img.shields.io/github/stars/efforg/panopticlick-python.svg?style=social)](https://github.com/efforg/panopticlick-python)
* [BrowserLeaks.com](https://www.browserleaks.com) - web browser security checklist for identity theft protection. It's all about Web Browser Fingerprinting. Here you will find the gallery of web browser security testing tools, that tell you what exactly personal identity data may be leaked without any permissions when you surf the Internet.
...
* :star: [Let's Encrypt](https://letsencrypt.org) - It’s free, automated, and open certificate authority. [CT Log from COMODO](https://crt.sh/?Identity=%25&iCAID=7395) :ru: Let’s Encrypt – свободный, бесплатный центр сертификации. Он должен обеспечить всех желающих совершенно бесплатными сертификатами, и тем самым, постепенно перевести весь интернет на шифрование трафика. [![Follow @letsencrypt](https://img.shields.io/twitter/url/https/letsencrypt.org.svg?label=@letsencrypt&style=social)](https://twitter.com/letsencrypt) [![GitHub stars](https://img.shields.io/github/stars/letsencrypt/letsencrypt.svg?style=social)](https://github.com/letsencrypt/letsencrypt)
...
* [TBS INTERNET test certificates](https://www.tbs-certificates.co.uk/certificats_test.html.en) - Free for 30 days, they are delivered according to a simplified process and are technically equivalent to the final products.
...
* [Iconogen](http://iconogen.com) - A free to use favicon, Windows 8 tiles, Apple Touch icon generator and iOS icon generator.
...
* [GitHub Gist](https://gist.github.com) - Gist is a simple way to share snippets and pastes with others. All gists are Git repositories, so they are automatically versioned, forkable and usable from Git. Gists are an easy way to work with small bits of code without creating a fully fledged repository. However, Gists do not support directories. All files need to be added to the repository root.
* [Codeshare](https://codeshare.io) - Share code snippets real-time in your browser and collaborate with developers with this free code sharing tool.
* [bl.ocks.org](http://bl.ocks.org) - a simple viewer for code examples hosted on [GitHub Gist](https://gist.github.com). Code up an example using Gist, and then point people here to view the example and the source code, live! [![GitHub stars](https://img.shields.io/github/stars/mbostock/bl.ocks.org.svg?style=social)](https://github.com/mbostock/bl.ocks.org)
...
* [CodePile](https://www.codepile.net) - a simple, powerful, collaborative code sharing hub, designed to make sharing and working on code together easy, beautiful, and interactive.
* [CSSDeck](http://cssdeck.com/labs) - a place where you can quickly create some experiments (or testcases) that involves HTML, CSS, JS code.
...
* [PHP Sandbox](http://sandbox.onlinephpfunctions.com) - Run, execute and test PHP code from your browser.
...
|[![Placeholder Image](http://lorempixel.com/400/200)](http://lorempixel.com/400/200)|[lorempixel](http://lorempixel.com) - Placeholder Images for every case. Webdesign or Print. Just put a custom url in your html and you receive a proper placeholder picture. ![Only HTTP][Only HTTP Icon]<hr>http://lorempixel.com/400/200|
|[![Placeholder Image](https://placeimg.com/400/200)](https://placeimg.com/400/200)|[PlaceIMG](https://placeimg.com) - Placeholder images for your project in progress. Custom URLs generate placeholder pictures in various sizes with categories and effects. [![Follow @placeIMG](https://img.shields.io/twitter/url/http/placeimg.com.svg?label=@placeIMG&style=social)](https://twitter.com/placeimg)<hr>https://placeimg.com/400/200|
|[![Placeholder Image](http://placemi.com/400x200)](http://placemi.com/400x200)|[placemi - the ultimate placeholder generator](http://placemi.com) - placemi generates beautiful image placeholders. you can even upload your own too. ![Only HTTP][Only HTTP Icon]<hr>http://placemi.com/400x200|
|[![Placeholder Image](https://placekitten.com/g/400/200)](https://placekitten.com/g/400/200)|[{placekitten}](http://placekitten.com) - Kitten-themed placeholder images for developers :3.<hr>https://placekitten.com/g/400/200|
|[![Placeholder Image](https://placehold.it/400x200)](https://placehold.it/400x200)|[Placehold.it](https://placehold.it) - Quick and simple image placeholders.<hr>https://placehold.it/400x200|
|[![Placeholder Image](https://fakeimg.pl/400x200/)](https://fakeimg.pl/400x200/)|[Fake images please?](http://fakeimg.pl) - Fakeimg.pl is a little tool that generates images with an URL. Choose the size, the colors, even the text. Oh… and it’s free. [![GitHub stars](https://img.shields.io/github/stars/Rydgel/Fake-images-please.svg?style=social)](https://github.com/Rydgel/Fake-images-please)<hr>https://fakeimg.pl/400x200/|
|[![Placeholder Image](https://unsplash.it/400/200/?random)](https://unsplash.it/400/200/?random)|:star: [Unsplash It](https://unsplash.it) - Beautiful placeholders using images from unsplash. [![GitHub stars](https://img.shields.io/github/stars/DMarby/unsplash-it.svg?style=social)](https://github.com/DMarby/unsplash-it)<hr>https://unsplash.it/400/200/?random|
|[![Placeholder Image](http://nicenicejpg.com/400/200)](http://nicenicejpg.com/400/200)|[Nice Nice JPG](http://nicenicejpg.com) - The only image placeholder service on the web bringing you nothing but Vanilla Ice jpgs. You're welcome. [![GitHub stars](https://img.shields.io/github/stars/timboisvert/NiceNiceJPG.svg?style=social)](https://github.com/timboisvert/NiceNiceJPG) ![Only HTTP][Only HTTP Icon]<hr>http://nicenicejpg.com/400/200|
|[![Placeholder Image](https://placezombie.com/400x200)](https://placezombie.com/400x200)|[Placezombie](https://placezombie.com) - Cloud Based Zombie Image Placeholder Service. A quick and simple service for getting pictures of zombies as placeholders in your designs. Read the [blog post about](https://longren.io?p=7588) how this site came back to life. [![GitHub stars](https://img.shields.io/github/stars/tlongren/placezombie.svg?style=social)](https://github.com/tlongren/placezombie)<hr>https://placezombie.com/400x200|
|[*censored*](http://placeboobs.com/400/200)|[Placeboobs.com](http://placeboobs.com) - an image placeholder service inspired by placekitten.com and placehold.it. While kittens are cute and all, they have one major drawback... They're not boobs. ![Only HTTP][Only HTTP Icon]<hr>http://placeboobs.com/400/200|
|[![Placeholder Image](https://imgholder.ru/400x200)](https://imgholder.ru/400x200)|:ru: [Image Holder](https://imgholder.ru) - полезный сервис и плагин для SublimeText, позволяющий с лёгкостью генерировать картинки-заглушки нужного размера, любого цвета, c произвольным текстом и шрифтом.<hr>https://imgholder.ru/400x200|
...
* [Name.ly](http://name.ly) - all your sites under one jingling address. ![Only HTTP][Only HTTP Icon] [![Name.ly API][API Icon]](http://name.ly/api/)
...
* [Pagoda Box](https://pagodabox.io) - Deploy and build your app via a single config file. Launch fully customizable servers in the context of your PaaS app. [SitePoint: Introducing Pagoda Box - a PaaS just for PHP](https://sitepoint.com/?p=98673)
...
* [Zoompf | Web Performance Optimization for the Enterprise](https://zoompf.com) - Comprehensive web performance and mobile performance platform for the enterprise web team.
